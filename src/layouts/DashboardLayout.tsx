    ...
    <>
      ...
      <SidebarProvider>
        ...
        <SidebarInset className="relative min-h-screen flex flex-col">
          <header className="flex h-12 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-10 sticky top-0 z-30 bg-background">
